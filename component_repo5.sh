...
function usage() {
  ...
  echo "component = one among  [test-component1_repo5
                                test-component2_repo5
                                test-component3_repo5]"
...
function check_component() {
  ...
  case ${COMPONENT_NAME} in
    test-component1_repo5)
    DOCKERFILE_PATH=./components_repo5/test-component1_repo5/Dockerfile
    ;;
    test-component2_repo5)
    DOCKERFILE_PATH=./components_repo5/test-component2_repo5/Dockerfile
    ;;
    test-component3_repo5)
    DOCKERFILE_PATH=./components_repo5/test-component3_repo5/Dockerfile
    ;;
    *)
